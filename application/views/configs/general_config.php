<?php echo form_open('config/save_general/', array('id' => 'general_config_form', 'enctype' => 'multipart/form-data', 'class' => 'form-horizontal')); ?>
	<div id="config_wrapper">
		<fieldset id="config_info">
			...
			<div class="form-group form-group-sm">
				<?php echo form_label($this->lang->line('config_advanced_search_filter'), 'config_advanced_search_filter', array('class' => 'control-label col-xs-2')); ?>
				<div class='col-xs-1'>
					<?php echo form_checkbox(array(
						'name' => 'advanced_search_filter',
						'id' => 'advanced_search_filter',
						'value' => 1,
						'checked' => $this->config->item('advanced_search_filter'))); ?>
				</div>
			</div>
